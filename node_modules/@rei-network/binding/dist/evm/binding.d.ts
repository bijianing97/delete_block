...
export declare type LastBlockHashesLoader = () => (string | Buffer)[];
...
export declare type AccessList = [string, string[]][];
...
export declare class JSEVMBinding {
     ...
     */
    runTx(stateRoot: string, header: Buffer | BlockHeader, tx: Buffer | Transaction, gasUsed: string | number, loader: LastBlockHashesLoader): {
        stateRoot: string;
     ...
     * @param loader - A function used to load block hash
     */
    runCall(stateRoot: string, header: Buffer | BlockHeader, tx: Buffer | Transaction, gasUsed: string | number, loader: LastBlockHashesLoader): string;
    /**
     * Execute message.
     * @param stateRoot - Previous state root hash
     * @param header - RLP encoded block header or header object
     ...
     * @param loader - A function used to load block hash
     */
    runMessage(stateRoot: string, header: Buffer | BlockHeader, message: Message, gasUsed: string | number, loader: LastBlockHashesLoader): {
        stateRoot: string;
        result: ExecutionResult;
        logs: Log[];
    };
