...
exports.decompressBytes = exports.compressBytes = void 0;
 ...
 */
function bitsetEncodeBytes(data) {
    if (data.length === 0) {
        return;
    }
    if (data.length === 1) {
    ...
    const nonZeroBitset = Buffer.alloc(Math.ceil(data.length / 8)).fill(0);
    const nonZeroBytes = [];
 ...
 */
function decompressBytes(data, target) {
 ...
 * @returns Decompressed data
 */
function bitsetDecodeBytes(data, target) {
 ...
 * @returns Decompressed data
 */
function bitsetDecodePartialBytes(data, target) {
    if (target === 0) {
