...
(function (DBTarget) {
    ...
    DBTarget[DBTarget["Receipts"] = 100] = "Receipts";
    DBTarget[DBTarget["TxLookup"] = 101] = "TxLookup";
    DBTarget[DBTarget["BloomBits"] = 102] = "BloomBits";
    DBTarget[DBTarget["BloomBitsSectionCount"] = 103] = "BloomBitsSectionCount";
...
class DBOp {
    constructor(operationTarget, key) {
        ...
        switch (operationTarget) {
            ...
            case DBTarget.Receipts: {
                this.baseDBOp.key = (0, constants_1.receiptsKey)(key.blockNumber, key.blockHash);
                this.cacheString = 'receipts';
                break;
            }
            case DBTarget.TxLookup: {
                this.baseDBOp.key = (0, constants_1.txLookupKey)(key.txHash);
                this.cacheString = 'txLookup';
                break;
            }
            case DBTarget.BloomBits: {
                this.baseDBOp.key = (0, constants_1.bloomBitsKey)(key.bit, key.section, key.hash);
                break;
            }
            case DBTarget.BloomBitsSectionCount: {
                this.baseDBOp.key = constants_1.BLOOM_BITS_SECTION_COUNT;
    ...
    static set(operationTarget, value, key) {
        ...
        if (operationTarget == DBTarget.BloomBits) {
            dbOperation.baseDBOp.value = (0, compress_1.compressBytes)(value);
        }
        else {
