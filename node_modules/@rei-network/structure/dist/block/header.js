...
exports.BlockHeader = exports.setCustomHashFunction = void 0;
...
function setCustomHashFunction(func) {
    customHashFunction = func;
}
exports.setCustomHashFunction = setCustomHashFunction;
/**
...
class BlockHeader {
    ...
    constructor(parentHash, uncleHash, coinbase, stateRoot, transactionsTrie, receiptTrie, bloom, difficulty, number, gasLimit, gasUsed, timestamp, extraData, mixHash, nonce, options = {}, baseFeePerGas) {
        ...
        if (options.common) {
            ...
            if (options.initWithGenesisHeader) {
                this._common = new common_1.Common({ chain, hardfork: common_1.Hardfork.Chainstart });
            }
            else {
                // This initializes on the Common default hardfork
                this._common = new common_1.Common({ chain });
            }
        }
        ...
        if (options.calcDifficultyFromHeader && this._common.consensusAlgorithm() === common_1.ConsensusAlgorithm.Ethash) {
    ...
    validateCliqueDifficulty(blockchain) {
        ...
        if ((inTurn && this.difficulty.eq(clique_1.CLIQUE_DIFF_INTURN)) || (!inTurn && this.difficulty.eq(clique_1.CLIQUE_DIFF_NOTURN))) {
            return true;
        }
        return false;
    }
     ...
     */
    raw() {
        const rawItems = [this.parentHash, this.uncleHash, this.coinbase.buf, this.stateRoot, this.transactionsTrie, this.receiptTrie, this.bloom, (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.difficulty), (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.number), (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.gasLimit), (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.gasUsed), (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.timestamp), this.extraData, this.mixHash, this.nonce];
        if (this._common.isActivatedEIP(1559)) {
     ...
     */
    hash() {
        return customHashFunction ? customHashFunction(this) : (0, ethereumjs_util_1.rlphash)(this.raw());
    }
    /**
