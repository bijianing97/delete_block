...
class Transaction extends baseTransaction_1.BaseTransaction {
    ...
    _getMessageToSign() {
        const values = [(0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.nonce), (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.gasPrice), (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.gasLimit), this.to !== undefined ? this.to.buf : Buffer.from([]), (0, ethereumjs_util_1.bnToUnpaddedBuffer)(this.value), this.data];
    ...
    //////////////////////////////////////
    /**
     * Convert tx to rpc json
     */
    toRPCJSON() {
        var _a, _b, _c;
        return {
            blockHash: ((_a = this.extension) === null || _a === void 0 ? void 0 : _a.blockHash) ? (0, ethereumjs_util_1.bufferToHex)(this.extension.blockHash) : null,
            blockNumber: ((_b = this.extension) === null || _b === void 0 ? void 0 : _b.blockNumber) ? (0, ethereumjs_util_1.bnToHex)(this.extension.blockNumber) : null,
            from: this.getSenderAddress().toString(),
            gas: (0, ethereumjs_util_1.bnToHex)(this.gasLimit),
            gasPrice: (0, ethereumjs_util_1.bnToHex)(this.gasPrice),
            hash: (0, ethereumjs_util_1.bufferToHex)(this.hash()),
            input: (0, ethereumjs_util_1.bufferToHex)(this.data),
            nonce: (0, ethereumjs_util_1.bnToHex)(this.nonce),
            to: this.to ? this.to.toString() : null,
            transactionIndex: ((_c = this.extension) === null || _c === void 0 ? void 0 : _c.transactionIndex) !== undefined ? (0, ethereumjs_util_1.intToHex)(this.extension.transactionIndex) : null,
            value: (0, ethereumjs_util_1.bnToHex)(this.value),
            v: this.v ? (0, ethereumjs_util_1.bnToHex)(this.v) : undefined,
            r: this.r ? (0, ethereumjs_util_1.bnToHex)(this.r) : undefined,
            s: this.s ? (0, ethereumjs_util_1.bnToHex)(this.s) : undefined
        };
    }
}
