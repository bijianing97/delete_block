...
class BaseTransaction {
    ...
    _getCommon(common, chainId) {
        ...
        if (chainId) {
            ...
            if (common) {
                ...
                if (common_1.Common.isSupportedChainId(chainIdBN)) {
                    // No Common, chain ID supported by Common
                    // -> Instantiate Common with chain ID
                    return new common_1.Common({ chain: chainIdBN, hardfork: this.DEFAULT_HARDFORK });
                }
                else {
                    throw new common_1.Common({ chain: this.DEFAULT_CHAIN, hardfork: this.DEFAULT_HARDFORK });
                }
            }
        }
        else {
            ...
            return (_a = common === null || common === void 0 ? void 0 : common.copy()) !== null && _a !== void 0 ? _a : new common_1.Common({ chain: this.DEFAULT_CHAIN, hardfork: this.DEFAULT_HARDFORK });
        }
    }
    ...
    get size() {
        let size = 0;
        for (const ele of this.raw()) {
            if (ele) {
                if (ele instanceof Buffer) {
                    size += ele.length;
                }
                else {
                    for (const [buf1, bufs] of ele) {
                        size += buf1.length;
    ...
    initExtension(block) {
        ...
        this.extension = new extension_1.TransactionExtension(block, index);
    }
}
